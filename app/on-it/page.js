  ...
  return (
    <main className="wrap section page-hero-section">
      <div className="eyebrow">
        <span>Built in-house · Software by Dynasty Web</span>
      </div>

      <h1 className="page-title">
        On <em>It</em> — Voice-powered invoicing for trades.
      </h1>
      ...
      >
        ...
        <p style={{ fontSize: "16px", color: "var(--ink-2)", lineHeight: "1.6", marginBottom: "28px" }}>
          Speak your line items, apply local tax, and text instant payment links to clients in seconds. No desktop accounting bloat or multi-tap mobile menus.
        </p>
